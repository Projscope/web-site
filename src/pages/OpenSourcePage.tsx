...
const categories = [
  {
    ...
    projects: [
      ...
      },
      {
        ...
        pageUrl: '/project/projscope-tasks',
      },
    ],
  },
  {
                ...
                {category.projects.map(project => (
                  <li key={project.url} className="oss-card">
                    ...
                    <div className="oss-card__footer">
                      ...
                      <div className="oss-card__btn-group">
                        {(project as { pageUrl?: string }).pageUrl && (
                          <Link to={(project as { pageUrl: string }).pageUrl} className="btn btn--primary oss-card__btn">
                            View Details
                          </Link>
                        )}
